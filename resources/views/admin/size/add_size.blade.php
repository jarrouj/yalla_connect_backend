<button type="button" class="btn btn-dark mt-4" data-bs-toggle="modal" data-bs-target="#exampleModalSize">
    <i class="me-2 fs-6 bi bi-plus-lg"></i>
    Add Size
</button>

<div class="modal fade" id="exampleModalSize" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ url('/admin/add_size') }}" method="POST" enctype="multipart/form-data">
                @csrf
