...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " style="z-index: 1"
    id="sidenav-main">
    <div class="sidenav-header mb-3">
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            aria-hidden="true" id="iconSidenav"></i>
        <a class="" href="{{ url('/') }}">
            <img src="{{ asset('images/logo/yalla_connect.png') }}" width="130px" height="130px" class="d-block mx-auto p-3" alt="main_logo">
        </a>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 " href="{{ url('/admin') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_categories' == request()->path() ? 'main-color' : '' }}"
                    href="{{ url('/admin/show_categories') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_types' == request()->path() ? 'main-color' : '' }}"
                    href="{{ url('/admin/show_types') }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="bi bi-boxes text-primary text-sm opacity-10"></i>
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_user_balance' == request()->path() ? 'main-color' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link rounded-3 {{ 'admin/show_offers' == request()->path() ? 'main-color' : '' }}"
            ...
            {{-- <div class="dropdown  ms-3 rounded">
                <div class="w-100 mb-3 dropdown-toggle fw-bold pt-2" id="websiteContentDropdown" role="button"
